...
$sql = "SELECT fisnota.*, 
        ...
        LEFT JOIN pessoa AS emitente ON fisnota.idPessoaEmitente = emitente.idPessoa
        LEFT JOIN pessoa AS destinatario ON fisnota.idPessoaDestinatario = destinatario.idPessoa ";
$where = " where ";
