...
if ($BANCO == "PROGRESS") {
    ...
    if (isset ($impostos["conteudoSaida"][0])) { // Conteudo Saida - Caso de erro
        ...
        if (!isset ($impostos["fisnotaproduimposto"][1]) && ($jsonEntrada['idNota'] != null)) {  // Verifica se tem mais de 1 registro
            $impostos = $impostos["fisnotaproduimposto"][0]; // Retorno sem array
